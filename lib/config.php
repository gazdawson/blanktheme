 ...
 */
define('GOOGLE_ANALYTICS_ID', 'UA-XXXXX-Y'); // UA-XXXXX-Y (Note: Universal Analytics only, not Classic Analytics)
...
function krank_display_sidebar() {
  ...
  return apply_filters('krank_display_sidebar', $sidebar_config->display);
}
